/* Generated from MPIR gmp-h.in for Windows x64 with GMP version 6.1.2 */
/* GMP version set to 6.1.2 for Ledger compatibility (MPIR is API-compatible with GMP 6.x) */
/* See: https://github.com/BrianGladman/mpir */
