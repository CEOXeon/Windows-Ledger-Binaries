...
# 3b. Locate the Boost cmake config directory generated by b2 stage
...
# 4. Build Ledger
# GMP_PATH points to the committed gmp-include/ directory, which provides a gmp.h
# pre-processed from MPIR's gmp-h.in with version 6.1.2 (satisfies ledger's >= 6.1.2
# requirement; MPIR is fully API-compatible with GMP 6.1.2).
cd "$RepoRoot\ledger"
cmake -G "Visual Studio 17 2022" -A x64 `
    ...
    -DGMP_PATH:PATH="$RepoRoot/gmp-include" `
